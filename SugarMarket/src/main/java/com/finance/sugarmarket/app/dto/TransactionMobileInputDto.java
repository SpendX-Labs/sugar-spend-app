...
public class TransactionMobileInputDto {
    ...
    public TransactionMobileInputDto(CashFlowType cashFlowType, String cashFlowName, BigDecimal transactionAmount,
    ...
    public TransactionMobileInputDto() {
        super();
    }
